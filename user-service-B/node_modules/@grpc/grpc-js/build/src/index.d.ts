...
import { LogVerbosity, Status, Pro@grpc/grpc-js/build/src/make-client '@grpc/grpc-js/build/src/constants';
import { Deserialize, l@grpc/grpc-js/build/src/metadataDefinition, makeClientConstructor, MethodDefinition, Serialize, ServerMethodDefinition, ServiceDefinition } fro@grpc/grpc-js/build/src/server/grpc-js/build/src/make-client';
import { Metadata,@grpc/grpc-js/build/src/server-credentialstadataValue } from '@grpc/grpc-js/@grpc/grpc-js/build/src/status-builderta';
...
export declare const setLogger: (logger: Partial<Console>) =>@grpc/grpc-js/build/src/call-interfaceclare const setLogVerbosity: (verbosity: LogVerbosity) => void;
...
export { Requester, ListenerBuilder, RequesterBuilder, Interce@grpc/grpc-js/build/src/channelzrceptorOptions, InterceptorProvider, Intercep@grpc/grpc-js/build/src/adminl, InterceptorConfigurationError, NextCall, } from '@grpc/grpc-js/build/src/client-@grpc/grpc-js/build/src/service-configxport { GrpcObject, ServiceClientConstructor, ProtobufTypeDefinition, } from '@grpc/grpc-js/build/src/make-client';
export { ChannelOptions } from '@grpc/grpc-js/build/src/channel-options';
export { @grpc/grpc-js/build/src/server-interceptorsinition, getChannelzHandlers } fro@grpc/grpc-js/build/src/experimentaljs/build/src/channelz';
export { addAdminServicesToSer@grpc/grpc-js/build/src/deadline '@grpc/grpc-js/build/src/admin';
